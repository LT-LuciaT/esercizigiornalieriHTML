...
function concatString (str1, str2) {
  ...
  const result = (primaParte + secondaparte).toUpperCase();
  console.log (result);
}
...
console.log(sommaArray(risultato)); 

/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
function sommaArray(array) {
  return array.reduce((somma, num) => somma + num, 0);
}

// Esempio di utilizzo
const risultato2 = [1, 2, 3, 4, 5];
console.log(sommaArray(risultato2)); // Output: 15
...
const val = [1, 2, 3, 4, 5];
const incremento = 3;
console.log(incrementaArray(val, incremento));
...
console.log(lunghezzeStringhe(parole));
...
*/
function filmPiùVecchio(movies) {
...
const filmPiùVecchioTrovato = filmPiùVecchio(movies);
console.log(filmPiùVecchioTrovato);
...
*/
function filmMillennial(movies) {
